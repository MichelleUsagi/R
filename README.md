...
```
**Expected Behavior**
> The console will display the average population value. A bar chart appears showing population by age group. This example demonstrates how R can be used to move from raw data to visual insight in just a few lines of code.
